...
public class PageReservationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (etatCheckBox != null) {
			...
			String message = "Nous vous avons crée un compte sur notre site. Votre nom de reservation est "
					+ user.getNom() + " et votre mot de passe est " + user.getPassword() + ".";
			...
			try {
				envoyeurDeMail.envoyer_email("smtp.gmail.com", "465","estaminet.howardries.resto@gmail.com",
						user.getMail(), "Inscription", message);
			} catch (Exception e) {
				e.printStackTrace();
			}
