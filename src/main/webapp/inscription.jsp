        ...
        <div class="row">
            ...
            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                 ...
                                 <input type="radio" name="sexe" value="femme"/> Madame<br />
                                <input type="radio" name="sexe" value="homme"/> Monsieur<br />
                                <input type="radio" name="sexe" value="trav"/> Ni l'un ni l'autre<br />
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="PrÃ©nom" class="col-sm-3 control-label">PrÃ©nom</label>
                    <div class="col-sm-9">
                        <input type="text" id="Prenom" name="Prenom" placeholder="PrÃ©nom" class="form-control" autofocus style="width:300px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="date" id="birthDate" class="form-control" style="width:300px;">
                    </div>
                </div>
...
<option value="ZW">Zimbabwe</option>
                      ...
                      <div class="form-group">
                    <label for="PrÃ©nom" class="col-sm-3 control-label">Adresse</label>
                    <div class="col-sm-9">
                        <input type="text" id="adresse" placeholder="nÂ° Rue Ville Code Postale" class="form-control" autofocus style="width:300px;">
