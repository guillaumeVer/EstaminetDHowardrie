						...
						<tbody>
							<c:forEach var="plat" items="${listeDePlat}">
								<tr>
									...
									<td><a href="ModifierPlat?id=${plat.idPlat}"
										class="btn btn-default btn-lg" role="button"
										style="width: 200px;"> Modifier </a></td>
									<td><a href="SupprimerPlat?id=${plat.idPlat}"
										class="btn btn-default btn-lg" role="button"
					...
					<div class="container">
						...
						<form class="form-horizontal" role="form" action="Plats" method="post" accept-charset="UTF-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="checkBox" id="PlatDuJour" name="PlatDuJour" placeholder="Description"
