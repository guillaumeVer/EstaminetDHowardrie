			...
			<div class="box">
				<div class="col-lg-12">
					...
					<h2 class="intro-text text-center">
						Modifier <strong>Un plat</strong>
					</h2>
					<hr>
					<div class="container">


						<form class="form-horizontal" role="form" action="ModifierPlat" method="post" accept-charset="UTF-8">
							<div class="form-group">
								<label for="Nom" class="col-sm-3 control-label">Nom du
									plat</label>
								<div class="col-sm-9">
									<input type="text" id="Nom" name="Nom" value=${plat.nomPlat} placeholder="Nom"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
										<input type="number" step="0.01" id="Prix" name="Prix" value=${plat.prixPlat} placeholder="Prix"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="Description" name="Description" value=${plat.descriptionPlat} placeholder="Description"
										class="form-control" autofocus style="width: 300px;">
							...
							<div class="form-group">
								<div class="col-sm-9 col-sm-offset-3">
									<button type="submit" class="btn btn-primary btn-block"
										style="width: 150px;">Modifier</button>
									<button type="submit" class="btn btn-primary btn-block"
