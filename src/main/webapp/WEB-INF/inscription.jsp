						...
						<form class="form-horizontal" role="form" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="email" id="Email" name="Email" required="required"
										placeholder="Email" class="form-control" style="width: 300px;">

									<span class="erreur">${erreurs}</span> <br />
								</div>
							</div>
							<div class="form-group">
								<label for="password" class="col-sm-3 control-label">Mot
									de passe</label>
								<div class="col-sm-9">
							...
							<div class="form-group">
								<div class="col-sm-9 col-sm-offset-3">
									<div class="checkbox">
										<label> <input type="checkbox">j'accepte les <a
											href="#">termes</a>
										</label> <br />
							...
							<div class="form-group">
								<div class="col-sm-9 col-sm-offset-3">
									<button type="submit" class="btn btn-primary btn-block"
										style="width: 300px;">S'inscrire</button>
								</div>
							</div>
						</form>
						<!-- /form -->
