					...
					<div class="container">
						...
						<form class="form-horizontal" role="form" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="Prénom" name="Prenom"
										placeholder="Prénom" class="form-control" autofocus
										style="width: 300px;" value=${user.prenom}>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<a>L'email est votre identifiant. Vous ne pourvez donc pas
										le modifier</a>
								</div>
							</div>
							<div class="form-group">
								<label for="password" class="col-sm-3 control-label">Ancien
									mot de passe</label>
								<div class="col-sm-9">
							...
							<div class="form-group">
								<label for="password" class="col-sm-3 control-label">Nouveau
									mot de passe</label>
								<div class="col-sm-9">
							...
							<div class="form-group">
								<label for="password" class="col-sm-3 control-label">Confirmer
									mot de passe</label>
								<div class="col-sm-9">
                ...
                daysOfWeekDisabled: [0, 6]
							...
							<div class="form-group">
								<div class="col-sm-9 col-sm-offset-3">
									...
									<a href="MonProfil" class="btn btn-primary btn-block"
										role="button" style="width: 200px;"> Annuler </a> <a
										href="Desinscription" class="btn btn-primary btn-block"
										role="button"
										onclick="return confirm('Etes vous sur de vouloir supprimer votre compte?')"
										style="width: 200px;"> Se désinscrire </a>
								</div>
							</div>
						</form>
						<!-- /form -->
