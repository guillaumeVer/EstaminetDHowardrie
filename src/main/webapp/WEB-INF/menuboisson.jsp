...
<div  class="brand" > <a href="AcceuilAdministrateur" style="color: #FFFAF0;"> Estaminet d'Howardries </a> </div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="AcceuilAdministrateur">Estaminet d'Howardries</a>
            </div>
  ...
  <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Supprimer
        ...
        <td> <button type="button" class="btn btn-default btn-lg">
  <span class="glyphicon glyphicon-star" aria-hidden="true"></span> Plat du jour
</button></span></td>
      </tr>
         <tr class="success">
        <td>Waterzoi</td>
