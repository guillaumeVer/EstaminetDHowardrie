							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="Nom" name="Nom"
										value=${boisson.nomBoisson} placeholder="Nom"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="Description" name="Description"
										value=${boisson.descriptionBoisson}  placeholder="Nom"
										class="form-control" autofocus style="width: 300px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<input type="number" step="0.01" id="Prix" name="Prix"
										placeholder="Prix" class="form-control" value=${boisson.prix
										} autofocus style="width: 300px;" required>
